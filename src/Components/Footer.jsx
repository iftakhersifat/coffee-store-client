...
const Footer = () => {
        ...
        <div style={{ backgroundImage: "url('/assets/images/more/13.jpg')" }} className='p-4'>
            <div className='container mx-auto md:flex md:justify-between'>
                <div className='flex flex-col space-y-4'>
                    ...
                    <h1 className='text-2xl font-bold text-black'>Espresso Emporium</h1>
    ...
    <nav className="grid-flow-col gap-4 flex mb-10">
    ...
    <div className='space-y-4'>
        <h1 className='text-2xl font-bold text-black'>Connect with Us</h1>
        <form className='flex flex-col space-y-4'>
        <input type="text" name="name" placeholder='Name' className="p-2 border border-gray-100 rounded bg-[#FFFFFF]" />
        <input type="email" name="email" placeholder='Email' className="p-2 border border-gray-100 rounded bg-[#FFFFFF]" />
